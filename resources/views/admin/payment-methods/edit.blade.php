...
<div class="mb-4 mb-md-5 futuristic-card p-4 p-md-5" style="border-color: rgba(0, 102, 255, 0.3); background: linear-gradient(135deg, rgba(0, 102, 255, 0.1), rgba(124, 58, 237, 0.1));">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            <h1 class="h3 h4-md fw-bold mb-1" style="color: #0066ff;">Edit Payment Method</h1>
            <p class="mb-0 small" style="color: var(--text-secondary);">Update the payment method details</p>
        </div>
    </div>
</div>
            ...
            <div class="futuristic-card p-4 p-md-5 mb-4" style="border-color: rgba(0, 102, 255, 0.2);">
                <div class="row">
                    <div class="col-12 col-md-3 mb-4 mb-md-0">
                        ...
                        <p class="small mb-0" style="color: var(--text-secondary);">Update the payment method details.</p>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="name" id="name" required
                                       ...
                                       value="{{ old('name', $paymentMethod->name) }}" placeholder="e.g., GCash, Bank Transfer">
                                @error('name')
                            ...
                            <div class="col-12">
                                ...
                                <select name="type" id="type" required class="form-select @error('type') is-invalid @enderror">
                                    ...
                                    <option value="digital_wallet" {{ old('type', $paymentMethod->type) == 'digital_wallet' ? 'selected' : '' }}>Digital Wallet (GCash, PayMaya, etc.)</option>
                                    ...
                                    <option value="offline" {{ old('type', $paymentMethod->type) == 'offline' ? 'selected' : '' }}>Offline Payment</option>
                                </select>
                                @error('type')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" id="description" rows="3"
                                          ...
                                          placeholder="Optional description">{{ old('description', $paymentMethod->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="processing_fee" id="processing_fee" step="0.01" min="0" required
                                           ...
                                           value="{{ old('processing_fee', $paymentMethod->processing_fee) }}" placeholder="0.00">
                                </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="number" name="processing_time_hours" id="processing_time_hours" min="0" required
                                       ...
                                       value="{{ old('processing_time_hours', $paymentMethod->processing_time_hours) }}" placeholder="24">
                                ...
                                <div class="d-flex flex-wrap gap-4">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="requires_verification" id="requires_verification" value="1" 
                                               class="form-check-input"
                                               {{ old('requires_verification', $paymentMethod->requires_verification) ? 'checked' : '' }}>
