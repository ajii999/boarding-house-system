                        ...
                        <dd>
                            <div class="futuristic-card p-4" style="border-color: rgba(0, 102, 255, 0.2);">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="{{ Storage::url($booking->payment_receipt) }}" target="_blank" class="btn btn-sm" style="color: #0066ff;">
                                            <i class="fas fa-external-link-alt me-1"></i>View Full Size
                                        </a>
                                        <a href="{{ Storage::url($booking->payment_receipt) }}" download class="btn btn-sm" style="color: #22c55e;">
                                            <i class="fas fa-download me-1"></i>Download
                                        </a>
                                    </div>
                                </div>
                                <div class="position-relative">
                                    <img src="{{ Storage::url($booking->payment_receipt) }}" 
                                         alt="Payment Receipt" 
                                         class="img-fluid rounded cursor-pointer"
                                         style="max-height: 300px; object-fit: contain; border: 1px solid rgba(0, 102, 255, 0.2);"
                                         onclick="openReceiptModal('{{ Storage::url($booking->payment_receipt) }}')"
                            ...
                            <dd>
                                <div class="futuristic-card p-3" style="border-color: rgba(0, 102, 255, 0.2);">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <a href="{{ Storage::url($payment->receipt_image) }}" target="_blank" class="btn btn-sm" style="color: #0066ff;">
                                                <i class="fas fa-external-link-alt me-1"></i>View Full Size
                                            </a>
                                            <a href="{{ Storage::url($payment->receipt_image) }}" download class="btn btn-sm" style="color: #22c55e;">
                                                <i class="fas fa-download me-1"></i>Download
                                            </a>
                                        </div>
                                    </div>
