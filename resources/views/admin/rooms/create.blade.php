...
<div class="mb-4 mb-md-5 futuristic-card p-4 p-md-5" style="border-color: rgba(34, 197, 94, 0.3); background: linear-gradient(135deg, rgba(34, 197, 94, 0.1), rgba(0, 212, 255, 0.1));">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            <h1 class="h3 h4-md fw-bold mb-1" style="color: #22c55e;">Add New Room</h1>
            <p class="mb-0 small" style="color: var(--text-secondary);">Enter the room details and pricing</p>
        </div>
    </div>
</div>
            ...
            <div class="futuristic-card p-4 p-md-5 mb-4" style="border-color: rgba(0, 102, 255, 0.2);">
                <div class="row">
                    <div class="col-12 col-md-3 mb-4 mb-md-0">
                        ...
                        <p class="small mb-0" style="color: var(--text-secondary);">Enter the room details and pricing.</p>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="room_number" id="room_number" required
                                       ...
                                       value="{{ old('room_number') }}" placeholder="e.g., 101, A1, etc.">
                                @error('room_number')
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select name="pricing_period" id="pricing_period" required class="form-select @error('pricing_period') is-invalid @enderror">
                                    ...
                                    <option value="per_night" {{ old('pricing_period') == 'per_night' ? 'selected' : '' }}>Per Night</option>
                                    <option value="monthly" {{ old('pricing_period') == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" id="description" rows="3"
                                          ...
                                          placeholder="Room amenities, features, or special notes...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
